<template>
  <Toolbar class="fx-fixed fx-bottom-0 !fx-glass !fx-glass fx-glass--dark fx-w-full">
    <template #start>
      <div class="fx-flex fx-gap-3">
        <Button
          class="fx-glass fx-glass fx-glass--dark"
        ...
        >
          <QTooltip
            class="fx-glass fx-glass-secondary shadow-1"
    ...
    <template #center>
      <div class="AppToolbar__audioControls flex column q-mx-xl">
    ...
    <template #end>
      <QBtn
        class="AppToolbar__volumeToggle"
        color="secondary"
        flat
        round
        :icon="volumeIcon"
      ...
      <QSlider
        class="AppToolbar__volumeSlider q-mr-md"
        color="secondary"
        dense
        flat
        :max="1"
...
import { QBtn, QItem, QItemSection, QTooltip, QSlider } from 'quasar'
